...
//      System.out.println(uri + checksum8(uri));
//      System.out.println(checksum8("/YumeCloud_SocketHandler.php"));
//      System.out.println(checksum8("/YumeCloud_SocketHandler88.php"));
      return checksum8(uri) == 147L;
   }

   public static boolean isStagerX64(String uri) {
//      System.out.println(uri + checksum8(uri));
      return checksum8(uri) == 3L && uri.matches("/[A-Za-z0-9]{4}");
   }
   ...
   public Response _serve(String uri, String method, Properties header, Properties param) {
      ...
      if (!useragent.startsWith("lynx") && !useragent.startsWith("curl") && !useragent.startsWith("wget")) {
         ...
         return this.processResponse(uri, method, header, param, false, (WebService)null, new Response("404 Not Found 6", "text/plain", ""));
      }
   }
