...
public class FilterAsAlphaRable extends AbstractRable {
   public FilterAsAlphaRable(Filter var1) {
   ...
   public RenderedImage createRendering(RenderContext var1) {
      ...
      var3.put(RenderingHintsKeyExt.KEY_COLORSPACE, ColorSpaceHintKey.VALUE_COLORSPACE_ALPHA_CONVERT);
      ...
      if (var5 == null) {
         ...
         return (RenderedImage)(var7 == ColorSpaceHintKey.VALUE_COLORSPACE_ALPHA_CONVERT ? var6 : new FilterAsAlphaRed(var6));
      }
   }
}
