...
public class EndianUtils {
   ...
   public static long readSwappedUnsignedInteger(byte[] data, int offset) {
      return (long)(((data[offset + 0] & 255) << 0) + ((data[offset + 1] & 255) << 8) + ((data[offset + 2] & 255) << 16) + ((data[offset + 3] & 255) << 24));
   }
   ...
   public static long readSwappedUnsignedInteger(InputStream input) throws IOException {
      ...
      int value3 = read(input);
      int value4 = read(input);
      return (long)(((value1 & 255) << 0) + ((value2 & 255) << 8) + ((value3 & 255) << 16) + ((value4 & 255) << 24));
   }
