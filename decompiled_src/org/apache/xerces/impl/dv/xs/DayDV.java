...
public class DayDV extends AbstractDateTimeDV {
   ...
   protected XMLGregorianCalendar getXMLGregorianCalendar(AbstractDateTimeDV.DateTimeData var1) {
      return super.factory.newXMLGregorianCalendar(Integer.MIN_VALUE, Integer.MIN_VALUE, var1.unNormDay, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, var1.timezoneHr * 60 + var1.timezoneMin);
   }
}
