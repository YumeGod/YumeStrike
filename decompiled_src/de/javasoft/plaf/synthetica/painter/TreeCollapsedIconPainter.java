...
public class TreeCollapsedIconPainter extends SyntheticaBasicIconPainter {
   ...
   public TreeCollapsedIconPainter() {
      super((SynthContext)null, SyntheticaLookAndFeel.getInt("Synthetica.tree.collapsedIcon.size", (Component)null, 12), SyntheticaLookAndFeel.getInt("Synthetica.tree.collapsedIcon.size", (Component)null, 12));
   }
