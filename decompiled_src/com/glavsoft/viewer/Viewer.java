...
public class Viewer extends JPanel implements Runnable, IRfbSessionListener, WindowListener, IChangeSettingsListener {
   ...
   private void showConnectionInfoMessage(String title) {
      ...
      message.append("Color format: ").append(String.valueOf(Math.round(Math.pow(2.0, (double)this.workingProtocol.getPixelFormat().depth)))).append(" colors (").append(String.valueOf(this.workingProtocol.getPixelFormat().depth)).append(" bits)\n");
