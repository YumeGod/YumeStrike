   ...
   public void paintComponent(Graphics g) {
      if (this.renderer != null) {
         ...
         synchronized(this.cursor) {
            ...
            if (this.showCursor && cursorImage != null && (this.scaleFactor != 1.0 || g.getClipBounds().intersects((double)this.cursor.rX, (double)this.cursor.rY, (double)this.cursor.width, (double)this.cursor.height))) {
