...
public class UiSettings {
   ...
   public void zoomOut() {
      ...
      double scaleFactor = (double)((int)(this.scalePercent / 10.0) * 10);
   ...
   public void zoomIn() {
      double scaleFactor = (double)((int)(this.scalePercent / 10.0) * 10 + 10);
   ...
   public void zoomToFit(int containerWidth, int containerHeight, int fbWidth, int fbHeight) {
      int scalePromille;
      for(scalePromille = Math.min(1000 * containerWidth / fbWidth, 1000 * containerHeight / fbHeight); (double)(fbWidth * scalePromille) / 1000.0 > (double)containerWidth || (double)(fbHeight * scalePromille) / 1000.0 > (double)containerHeight; --scalePromille) {
      }
