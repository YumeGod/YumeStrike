...
public class VoiceFamily extends Property {
   ...
   public static final String[] familyNames = new String[]{"male", "female", "child"};
   private static final Hashtable familyIndexes = new Hashtable();

   public VoiceFamily(int var1, String var2, int var3, boolean var4, byte[] var5, int[] var6, Value var7) {
